<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="EXAMEN_2P.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="EXAMEN_2P" %>
